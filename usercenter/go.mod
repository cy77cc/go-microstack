module github.com/cy77cc/go-microstack/usercenter

go 1.25.5

replace (
	github.com/cy77cc/go-microstack => ../..
	github.com/cy77cc/go-microstack/common => ../common
)

require (
	github.com/cy77cc/go-microstack/common v0.0.0-00010101000000-000000000000
