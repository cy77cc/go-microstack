...
type (
	userRolesModel interface {
		...
		FindOneByUserIdRoleId(ctx context.Context, userId uint64, roleId uint64) (*UserRoles, error)
...
func (m *defaultUserRolesModel) FindOneByUserIdRoleId(ctx context.Context, userId uint64, roleId uint64) (*UserRoles, error) {
