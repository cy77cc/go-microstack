...
func (m *defaultUsersModel) Insert(ctx context.Context, data *Users) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Username, data.PasswordHash, data.Email, data.Phone, data.Avatar, data.Status, data.LastLoginTime)
	}, usersIdKey, usersUsernameKey)
	return ret, err
}
...
func (m *defaultUsersModel) Update(ctx context.Context, newData *Users) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Username, newData.PasswordHash, newData.Email, newData.Phone, newData.Avatar, newData.Status, newData.LastLoginTime, newData.Id)
	}, usersIdKey, usersUsernameKey)
	return err
}
